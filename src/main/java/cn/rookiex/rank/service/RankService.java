...
public interface RankService {
     ...
     * @throws RedisInitFailException redis not init
     */
    RankData getRankDataByRank(int rank, String rankName) throws RedisInitFailException;
     ...
     * @throws RedisInitFailException redis not init
     */
    RankData getRankDataByValue(int value, String rankName) throws RedisInitFailException;
